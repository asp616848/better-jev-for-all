...
**Full run launched**: `checkpoints/ekvachan-decoder-qwen-vision`, 78,000 examples, one epoch, auto-detected vision settings. Estimated ~7-8 GPU-hours per 5.2b's own measured-rate projection. Results in the next dated entry once it lands.
